...
macOS Sonoma以降向けのメニューバーアプリと通知センターウィジェットに加え、開発中のiPhone / iPadコンパニオンを含みます。Mac版ではChatGPT Codex / Claude Code の使用量（5時間+週、またはプロバイダが月間ウィンドウを返す場合は月間）、GitHub Copilot の使用量（月間プレミアムリクエスト）、ccusage のトークン使用量を表示します。
